package org.apache.hadoop.experiment_01;
...
public class Calculate_NodeDegree extends Configured implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job1.setJobName( "Calculate Degree" );
        ...
        job1.setJarByClass( Calculate_NodeDegree.class );
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run( new Configuration(), new Calculate_NodeDegree(), args );
        System.exit( res );
    }
}